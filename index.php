...
<body>
    <nav class="container-fluid navbar fixed-top navigation bg-light">
        ...
        <div class="col-6 navbar">
            <div class="col-3">
                <a href="http://" class="btn text-warning">Vagas</a>
            </div><!--Fecha Vagas-->
            <div class="col-3">
                <a href="http://" class="btn text-warning">Anuncie</a>
            </div><!--Fecha Anuncie-->
            <div class="col-3">
                <a href="http://" class="btn text-warning">Entenda</a>
            </div><!--Fecha Entenda-->
            <div class="col-3">
                <a href="http://" class="btn text-warning">Sobre</a>
            </div><!--Fecha Sobre-->
        ...
        <div id="carouselExampleFade" class="carousel slide container-lg border-warning rounded-bottom rounded-lg p-1 bg-light shadow-lg border mb-5 rounded" data-ride="carousel">
            <div class="carousel-inner">
                ...
                <div class="carousel-item">
                    <img src="./src/image/b-2-carousel.png" class="d-block w-100" alt="b-2-carousel">
                </div>
                <div class="carousel-item">
                    <img src="./src/image/b-3-carousel.png" class="d-block w-100" alt="b-3-carousel">
                </div>
            </div>
