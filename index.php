...
<body>
    ...
    <nav class="container-fluid navbar fixed-top navigation bg-light border border-warning rounded-bottom rounded border-top-0"><!--Abre nav-->
        ...
        <div class="col-6 navbar"><!--Abre Elementos de pesquisa-->
            ...
            <div class="col-3"><!--Abre Anuncie-->
                <a href="/anuncie" class="btn text-warning">Anuncie</a>
            </div><!--Fecha Anuncie-->

            <div class="col-3"><!--Abre entenda-->
                <a href="/entenda" class="btn text-warning">Entenda</a>
            </div><!--Fecha Entenda-->

            <div class="col-3"><!--Abre Sobre-->
                <a href="/sobre" class="btn text-warning">Sobre</a>
            </div><!--Fecha Sobre-->
